                                        ...
                                        <div id="account-details-modern" class="content m-0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" id="modern-username" name="username" class="form-control" placeholder="johndoe" />
                                                </div>
                                                <div class="form-group col-md-6">
                                        ...
                                        <div id="personal-info-modern" class="content m-0">
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" id="modern-first-name" name="legal_name" class="form-control" placeholder="John" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-first-name">Company Name</label>
                                                    <input type="text" id="modern-first-name" name="company_name" class="form-control" placeholder="John" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" id="modern-last-name" name="company_phone" class="form-control" placeholder="Doe" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-last-name">Company Email</label>
                                                    <input type="email" id="modern-last-name" name="company_email" class="form-control" placeholder="Doe" />
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="form-label" for="modern-last-name">Office Address</label>
                                                    <input type="text" id="modern-last-name" name="address" class="form-control" placeholder="Doe" />
                                                </div>
                                            </div>
                                        ...
                                        <div id="social-links-modern" class="content m-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="date" id="" name="subscription_expiry" class="form-control">
                                                </div>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <button type="button" class="btn btn-primary btn-prev">
