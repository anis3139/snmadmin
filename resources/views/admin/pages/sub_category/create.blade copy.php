                    ...
                    <div class="card-title">
                        <div class="row">
                            ...
                            <div class="col s12 m6 l2">
                                <ul class="tab">
                                    <li class="tab col s6 p-0"><a class="p-0" href="{{ route('subcategory.index') }}">List</a></li>
                                    <li class="tab col s6 p-0"><a class="p-0" href="{{ route('subcategory.create') }}">Add</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                    <div id="view-input-fields">
                        <div class="row">
                            <div class="col s12">
                                ...
                                <form class="row" action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data" files="true">
                                    @csrf
                                    ...
                                    <div class="col s12">
                                        <div class="input-field col s12">
                                            ...
                                            <span class="helper-text red-text" data-error="wrong" data-success="right">{{ $errors->first('category_id') }}</span>
                                        </div>
                                    </div>
...
@push('custom-js')
    ...
    <!-- END PAGE LEVEL JS-->
    <!-- BEGIN PAGE LEVEL JS-->
    <script src="{{ asset('admin/app-assets/js/scripts/form-elements.js')}}"></script>
    <!-- END PAGE LEVEL JS-->
@endpush
