...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ $setting->default_url }}app-assets/images/ico/favicon.ico">
    ...
    <link rel="stylesheet" type="text/css" href="{{ $setting->default_url }}app-assets/css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="{{ $setting->default_url }}app-assets/css/pages/page-auth.css">
    <!-- END: Page CSS-->
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ $setting->default_url }}app-assets/images/pages/login-v2.svg" alt="Login V2" /></div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
...
<!-- BEGIN: Page JS-->
<script src="{{ $setting->default_url }}app-assets/js/scripts/pages/page-auth-login.js"></script>
<!-- END: Page JS-->
